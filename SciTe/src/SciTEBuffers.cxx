...
//added		↓
	...
	{
		MenuText=props.GetNewExpandString("command.compile.name.", FileNameExt().AsUTF8().c_str());
	...
	{
		MenuText=props.GetNewExpandString("command.build.name.", FileNameExt().AsUTF8().c_str());
	...
	{
		MenuText=props.GetNewExpandString("command.go.name.", FileNameExt().AsUTF8().c_str());
